    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Data Ruang</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
        ...
        <div class="content">
            <div class="card card-info card-outline">
                ...
                <div class="card-body">
                    <form action="/update-ruang/{{ $ruang->id }}" method="post">
                        {{ csrf_field() }}
                        <div class="form-group">
                            <input type="text" class="form-control @error('kd_ruang') is-invalid @enderror" name="kd_ruang"
                                placeholder="Kode Ruang" value="{{ $ruang->kd_ruang }}">
                            @error('kd_ruang')
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control @error('nm_ruang') is-invalid @enderror" name="nm_ruang"
                                placeholder="Nama Ruang" value="{{ $ruang->nm_ruang }}">
                            @error('nm_ruang')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control @error('kapasitas') is-invalid @enderror"
                                name="kapasitas" placeholder="Kapasitas" value="{{ $ruang->kapasitas }}">
                            @error('kapasitas')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control @error('fasilitas') is-invalid @enderror"
                                name="fasilitas" placeholder="Fasilitas" value="{{ $ruang->fasilitas }}">
                            @error('fasilitas')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
