                    ...
                    <form wire:submit.prevent="create">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                wire:model="name" placeholder="Nama Peminjam" disabled required>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control @error('no_induk') is-invalid @enderror"
                                wire:model="no_induk" placeholder="NIM/NIP" disabled required>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control @error('prodi') is-invalid @enderror"
                                wire:model="prodi" placeholder="Program Studi" disabled required>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control @error('nohp') is-invalid @enderror"
                                wire:model="nohp" placeholder="No Telepon" disabled required>
                        </div>
                        <div class="form-group">
                        ...
                        @foreach ($jadwal as $jadwals)
                            <div class="form-check form-check-inline">
                                <input class="form-check-input @error('waktu') is-invalid @enderror"
                                    wire:model.defer="waktu" type="checkbox" id="inlineCheckbox1"
                                    @if ($waktu_peminjaman->where('jadwal_id', $jadwals->id)->count() != 0) disabled @endif value="{{ $jadwals->id }}">
                        ...
                        <div class="form-group">
                            <input type="file" class="form-control @error('file') is-invalid @enderror"
                                wire:model="file" placeholder="Upload SIK" required>
                            @error('file')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
