...
class CreatePengajuan extends Component
{
    use WithFileUploads;
    ...
    public function mount()
    {
        ...
        $this->no_induk = auth()->user()->nim;
        $this->prodi = auth()->user()->prodi;
        $this->nohp = auth()->user()->nomorhp;
    }
    ...
    public function create()
    {
        $credentials = $this->validate([
            ...
            'file' => 'mimes:doc,pdf,docx,jpg,png',
        ]);
    ...
    public function render()
    {
        ...
        return view('livewire.user.create-pengajuan', [
            'jadwal' => Jadwal::all(),
            'ruang' => Ruang::all(),
            'barang' => Barang::all(),
